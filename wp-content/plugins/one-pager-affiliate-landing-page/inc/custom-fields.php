    ...
    if (function_exists('acf_add_local_field_group')) {
        acf_add_local_field_group(array(
            ...
            'fields' => array(
                ...
                // Add a new field for video description
                array(
                ...
                array(
                    'key' => 'field_payment_logo_1',
                    'label' => 'Security Payment Logo 1',
                    'name' => 'payment_logo_1',
                    'type' => 'image',
                    'instructions' => 'Upload the first payment logo.',
                    'return_format' => 'url',
                ),
                array(
                    'key' => 'field_payment_logo_2',
                    'label' => 'Security Payment Logo 2',
                    'name' => 'payment_logo_2',
                    'type' => 'image',
                    'instructions' => 'Upload the second payment logo.',
                    'return_format' => 'url',
                ),
                array(
                    'key' => 'field_payment_logo_3',
                    'label' => 'Security Payment Logo 3',
                    'name' => 'payment_logo_3',
                    'type' => 'image',
                    'instructions' => 'Upload the third payment logo.',
                    'return_format' => 'url',
                ),
                array(
